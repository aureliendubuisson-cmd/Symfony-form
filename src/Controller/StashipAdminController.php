...
final class StashipAdminController extends AbstractController
{
    #[Route(name: 'app_staship_admin_index', methods: ['GET'])]
    public function index(StarshipRepository $starshipRepository): Response
    {
        return $this->render('staship_admin/index.html.twig', [
            'starships' => $starshipRepository->findAll(),
        ]);
    }

    #[Route('/new', name: 'app_staship_admin_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_staship_admin_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->render('staship_admin/new.html.twig', [
            'starship' => $starship,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_staship_admin_show', methods: ['GET'])]
    public function show(Starship $starship): Response
    {
        return $this->render('staship_admin/show.html.twig', [
            'starship' => $starship,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_staship_admin_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Starship $starship, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('staship_admin/edit.html.twig', [
            'starship' => $starship,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_staship_admin_delete', methods: ['POST'])]
